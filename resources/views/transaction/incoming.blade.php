                    ...
                    <tr>
                      ...
                      <td class="p-4 text-sm text-gray-700 whitespace-nowrap">                                
                        <div class="inline-flex rounded-md" role="group">
                          ...
                          <button type="button" data-modal-target="editModal{{ $transaction->id }}" data-modal-toggle="editModal{{ $transaction->id }}" class="text-blue-700 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-4 focus:ring-blue-400 font-medium rounded-full text-sm px-2.5 py-2.5 text-center mr-1 my-2">
